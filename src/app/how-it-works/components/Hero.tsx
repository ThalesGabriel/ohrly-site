            ...
            <div className="relative mx-auto flex min-h-screen max-w-7xl flex-col justify-center px-8 py-12 md:px-12">
                <div className="max-w-7xl">
                    ...
                    <h1 className="max-w-6xl text-5xl font-bold leading-[1.02] tracking-tight text-zinc-950 md:text-6xl">
                        Operações digitais perdem coerência progressivamente até que
                        <span className="text-violet-600"> agir tarde demais seja tolerável.</span>
                    </h1>

                    <p className="mt-8 max-w-4xl text-lg leading-relaxed text-zinc-600 md:text-xl">
                        O Ohrly transforma comportamento operacional em clareza contínua para que Produto, Engenharia, Operações e liderança consigam interpretar a mesma realidade antes que esperar comece a ficar caro.
                    </p>
                </div>
