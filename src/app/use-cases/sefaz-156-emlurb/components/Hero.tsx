            ...
            <div className="relative mx-auto flex min-h-screen max-w-7xl flex-col justify-center px-8 py-12 md:px-12">
                <div className="max-w-7xl">
                    <p className="mb-5 text-xs font-bold uppercase tracking-[0.22em] text-violet-600">
                        Detectando degradação silenciosa antes do colapso operacional
                    </p>

                    <h1 className="max-w-6xl text-5xl font-bold leading-[1.02] tracking-tight text-zinc-950 md:text-6xl">
                        Análise comportamental baseada em ~87 mil solicitações operacionais reais da Central 156
                        <span className="text-violet-600"> (Emlurb/SEFAZ).</span>
                    </h1>

                    <p className="mt-8 max-w-4xl text-lg leading-relaxed text-zinc-600 md:text-xl">
                        O principal avanço deste estudo foi identificar quando a operação começou a perder capacidade natural de recuperação.
                    </p>
                </div>
